...
class transform: #aqui vai o nome do plugin
    def __init__(self):
        pass
...
#################################################################################################
    ...
    def execute(self):
        ...
        transform_type = self.params['comboBox']['value']

        if transform_type == 'Indicators':
...
#################################################################################################
    ...
    def name(self):
        return "transform" #aqui vai o nome do plugin
